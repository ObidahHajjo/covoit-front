...
function DetailCard({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-[12px] bg-[var(--theme-bg-soft)] p-4">
      <p className="text-xs font-medium uppercase tracking-[0.15em] text-[var(--theme-muted)]">
        {label}
      </p>
  ...
  return (
    <div className="mt-8">
      <div className="mb-4 flex items-center gap-3">
        <div className="h-px flex-1 bg-[var(--theme-line)]" />
    ...
    <div className="mx-auto w-full max-w-5xl px-4 py-6 sm:px-6 lg:px-0">
      ...
      <section className="overflow-hidden rounded-[24px] border border-[var(--theme-line)] bg-[var(--theme-bg-soft)] px-5 py-6 text-[var(--theme-ink)] sm:px-7 sm:py-8">
        ...
        <div className="mt-3 flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <h1 className="text-4xl font-medium leading-[1.1] text-[var(--theme-ink)] sm:text-5xl">
              {from} - {to}
            </h1>
          ...
          <span className="inline-flex rounded-full border border-[var(--theme-line)] bg-[var(--theme-surface)] px-4 py-2 text-sm font-medium text-[var(--theme-ink)]">
            Trip #{trip.id}
          </span>
        </div>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          ...
          <DetailCard
            ...
            value={
              trip.arrival_time ? formatDateTimeRaw(trip.arrival_time) : t("trip.arrivalPending")
            }
          />
          <DetailCard
          ...
          <DetailCard
            label={t("trip.seatsLeft")}
            value={t("trip.availableSeats", { count: trip.available_seats })}
          />
          <DetailCard
