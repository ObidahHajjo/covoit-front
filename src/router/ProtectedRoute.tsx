        ...
        return (
            <div className="flex min-h-screen items-center justify-center px-4">
                <div className="rounded-[2rem] border border-[var(--theme-line)] bg-[var(--theme-surface)] px-8 py-10 text-center shadow-[var(--theme-shadow-warm)] backdrop-blur-xl">
                    ...
                    <p className="mt-4 font-serif text-2xl text-[var(--theme-ink)]">Opening your dashboard...</p>
                    <p className="mt-2 text-sm text-[var(--theme-muted)]">We are checking your session and preparing your ride space.</p>
                </div>
            </div>
        );
    }
