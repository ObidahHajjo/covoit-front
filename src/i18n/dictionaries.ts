...
export const dictionaries = {
  en: {
    ...
    "auth.activeCommunity": "Connected people",
    ...
    "auth.activeCommunityBody": "Be part of a shared travel experience.",
    ...
    "car.licensePlateHint": "Use the format XX-000-XX.",
    "car.licensePlateInvalid": "License plate must use the format XX-000-XX.",
    "car.color": "Color",
    ...
    "bookings.seats": "{count} seat{suffix}",
    "bookings.distance": "{km} km",
    "bookings.driver": "Driver: {name}",
  ...
  fr: {
    ...
    "auth.activeCommunity": "Des personnes connectées",
    ...
    "auth.activeCommunityBody": "Faites partie d’une expérience de voyage partagée.",
    ...
    "car.licensePlateHint": "Utilisez le format XX-000-XX.",
    "car.licensePlateInvalid": "La plaque doit respecter le format XX-000-XX.",
    "car.color": "Couleur",
    ...
    "bookings.seats": "{count} place{suffix}",
    "bookings.distance": "{km} km",
    "bookings.driver": "Conducteur : {name}",
    "bookings.personCount": "{count} {label}",
  ...
  ar: {
    ...
    "auth.activeCommunity": "أشخاص متصلون",
    ...
    "activeCommunityBody": "كن جزءًا من تجربة سفر مشتركة.",
    "auth.feature": "ميزة",
    ...
    "car.licensePlateHint": "استخدم التنسيق XX-000-XX.",
    "car.licensePlateInvalid": "يجب أن تتبع لوحة الترخيص التنسيق XX-000-XX.",
    "car.color": "اللون",
    ...
    "bookings.seats": "{count} مقعد",
    "bookings.distance": "{km} كم",
    "bookings.driver": "السائق: {name}",
    "bookings.personCount": "{count} {label}",
    "bookings.person": "شخص",
